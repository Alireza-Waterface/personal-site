...
export async function generateMetadata() {
   ...
   return {
      ...
      robots: "index, follow",
      keywords:
         "فریلنسر,علیرضا آبچهره,برنامه نویس وب,برنامه نویس فرانت اند,توسعه دهنده فرانت اند,waterface,alireza waterface,alireza abchehre,abchehre,توسعه دهنده وب,برنامه نویس سایت,آبچهره,آب چره,پروژه,پروژه ها,نمونه‌کار,نمونه کار ها,تجربه کاری,سابقه کار",
      openGraph: {
         title: `علیرضا آبچهره | پروژه‌ها و نمونه‌کار ها - ${projects?.length} پروژه`,
         description:
            "علیرضا آبچهره | توسعه دهنده فرانت‌اند و فریلنسر | پروژه‌ها، نمونه‌کار ها و سوابق کاری",
         ...
         type: "website",
         images: [
            // configure for different image sizes
            {
