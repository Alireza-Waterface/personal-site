      ...
      <article className={classes.sample}>
         <section className={classes.container}>
            <div className={classes.gallery}>
               <ProjectGallery
                  cover={projectData.cover_image}
                  gallery={projectData.gallery_images}
               />
            </div>

            <header>
               <Heading type="h1" size={1.5} className={classes.title}>
                  {projectData.title}
               </Heading>
            </header>
            ...
            {projectData.github && (
               <Link
                  className={classes.link}
                  title="ریپازیتوری گیت‌هاب پروژه"
