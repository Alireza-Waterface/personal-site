...
export function ExpandableCardDemo({ data }) {
	...
	return (
		<>
			...
			<ul
				className=" mx-auto w-full grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 items-stretch gap-2">
						...
						<div className="flex gap-4 flex-col w-full">
							...
							<div className="flex justify-center items-center flex-col">
								...
								<motion.p
									...
									className="text-neutral-600 dark:text-neutral-400 text-justify">
									{ card.description.length > 100 ? card.description.slice(0, 100) + ' ...' : card.description.slice(0, 100) }
								</motion.p>
							</div>
						</div>
					</motion.div>
